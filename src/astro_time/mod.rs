...
impl Builder {
    ...
    ///
    /// It defaults to `TimeType::UT`.
    pub fn from_gregorian_utc(mut year: i32,
                              mut month: i32,
                              day: i32,
                              hour: i32,
                              minute: i32,
    ...
    ///
    /// It defaults to `TimeType::UT`.
    pub fn from_julian_utc(mut year: i32,
                           mut month: i32,
                           day: i32,
                           hour: i32,
                           minute: i32,
        ...
        if is_valid_julian(year, month, day) && is_valid_time(hour, minute, second) {
            ...
            let jd = f64::floor(365.25 * (year + 4716) as f64) +
                     f64::floor(30.6001 * (month + 1) as f64) + decimal_day -
                     1524.5;
...
mod astro_tm_bldr_tests {
    ...
    fn test_from_gregorian_utc() {
        ...
        //
        assert!(approx_eq(Builder::from_gregorian_utc(-99, 3, 1, 0, 0, 0)
                              .build()
                              .unwrap()
                              .julian_day_number(),
                          1_684_959.5,
        ...
        assert!(approx_eq(Builder::from_gregorian_utc(1957, 10, 4, 19, 26, 24)
                              .build()
                              .unwrap()
                              .julian_day_number(),
                          2_436_116.31,
        ...
        assert!(approx_eq(Builder::from_gregorian_utc(2000, 1, 1, 12, 0, 0)
                              .build()
                              .unwrap()
                              .julian_day_number(),
                          2_451_545.0,
        ...
        assert!(approx_eq(Builder::from_gregorian_utc(1999, 1, 1, 0, 0, 0)
                              .build()
                              .unwrap()
                              .julian_day_number(),
                          2_451_179.5,
        ...
        assert!(approx_eq(Builder::from_gregorian_utc(1987, 1, 27, 0, 0, 0)
                              .build()
                              .unwrap()
                              .julian_day_number(),
                          2_446_822.5,
        ...
        assert!(approx_eq(Builder::from_gregorian_utc(1987, 6, 19, 12, 0, 0)
                              .build()
                              .unwrap()
                              .julian_day_number(),
                          2_446_966.0,
        ...
        assert!(approx_eq(Builder::from_gregorian_utc(1988, 1, 27, 0, 0, 0)
                              .build()
                              .unwrap()
                              .julian_day_number(),
                          2_447_187.5,
        ...
        assert!(approx_eq(Builder::from_gregorian_utc(1988, 6, 19, 12, 0, 0)
                              .build()
                              .unwrap()
                              .julian_day_number(),
                          2_447_332.0,
        ...
        assert!(approx_eq(Builder::from_gregorian_utc(1900, 1, 1, 0, 0, 0)
                              .build()
                              .unwrap()
                              .julian_day_number(),
                          2_415_020.5,
        ...
        assert!(approx_eq(Builder::from_gregorian_utc(1600, 1, 1, 0, 0, 0)
                              .build()
                              .unwrap()
                              .julian_day_number(),
                          2_305_447.5,
        ...
        assert!(approx_eq(Builder::from_gregorian_utc(1600, 12, 31, 0, 0, 0)
                              .build()
                              .unwrap()
                              .julian_day_number(),
                          2_305_812.5,
        ...
        assert!(approx_eq(Builder::from_gregorian_utc(837, 4, 14, 7, 12, 0)
                              .build()
                              .unwrap()
                              .julian_day_number(),
                          2_026_871.8,
        ...
        assert!(approx_eq(Builder::from_gregorian_utc(-123, 12, 28, 0, 0, 0)
                              .build()
                              .unwrap()
                              .julian_day_number(),
                          1_676_496.5,
        ...
        assert!(approx_eq(Builder::from_gregorian_utc(-123, 12, 29, 0, 0, 0)
                              .build()
                              .unwrap()
                              .julian_day_number(),
                          1_676_497.5,
        ...
        assert!(approx_eq(Builder::from_gregorian_utc(-200, 7, 2, 12, 0, 0)
                              .build()
                              .unwrap()
                              .julian_day_number(),
                          1_648_194.0,
        ...
        assert!(approx_eq(Builder::from_gregorian_utc(-1000, 7, 3, 12, 0, 0)
                              .build()
                              .unwrap()
                              .julian_day_number(),
                          1_356_001.0,
        ...
        assert!(approx_eq(Builder::from_gregorian_utc(-4713, 11, 24, 12, 0, 0)
                              .build()
                              .unwrap()
                              .julian_day_number(),
                          0.0,
    ...
    fn test_from_julian_utc() {
        ...
        // Test things that should work
        //
        assert!(approx_eq(Builder::from_julian_utc(1957, 9, 21, 19, 26, 24)
                              .build()
                              .unwrap()
                              .julian_day_number(),
                          2_436_116.31,
        ...
        assert!(approx_eq(Builder::from_julian_utc(1999, 12, 19, 12, 0, 0)
                              .build()
                              .unwrap()
                              .julian_day_number(),
                          2_451_545.0,
        ...
        assert!(approx_eq(Builder::from_julian_utc(1998, 12, 19, 0, 0, 0)
                              .build()
                              .unwrap()
                              .julian_day_number(),
                          2_451_179.5,
        ...
        assert!(approx_eq(Builder::from_julian_utc(837, 4, 10, 7, 12, 0)
                              .build()
                              .unwrap()
                              .julian_day_number(),
                          2_026_871.8,
        ...
        assert!(approx_eq(Builder::from_julian_utc(-123, 12, 31, 0, 0, 0)
                              .build()
                              .unwrap()
                              .julian_day_number(),
                          1_676_496.5,
        ...
        assert!(approx_eq(Builder::from_julian_utc(-122, 1, 1, 0, 0, 0)
                              .build()
                              .unwrap()
                              .julian_day_number(),
                          1_676_497.5,
        ...
        assert!(approx_eq(Builder::from_julian_utc(-1000, 7, 12, 12, 0, 0)
                              .build()
                              .unwrap()
                              .julian_day_number(),
                          1_356_001.0,
        ...
        assert!(approx_eq(Builder::from_julian_utc(-1000, 2, 29, 0, 0, 0)
                              .build()
                              .unwrap()
                              .julian_day_number(),
                          1_355_866.5,
        ...
        assert!(approx_eq(Builder::from_julian_utc(-1001, 8, 17, 21, 36, 0)
                              .build()
                              .unwrap()
                              .julian_day_number(),
                          1_355_671.4,
        ...
        assert!(approx_eq(Builder::from_julian_utc(-4712, 1, 1, 12, 0, 0)
                              .build()
                              .unwrap()
                              .julian_day_number(),
                          0.0,
    ...
    fn get_delta_t(&self) -> f64 {
        ...
        if self.julian_day >= TIME_DELTA[0].0 &&
           self.julian_day < TIME_DELTA[TIME_DELTA.len() - 1].0 {
            ...
            ((top - bottom) / (right - left) * (self.julian_day - left) + bottom) / 86_400.0
        } else {
...
mod astro_time_tests {
    ...
    fn test_modified_julian_day_number() {
        assert!(approx_eq(Builder::from_gregorian_utc(1858, 11, 17, 0, 0, 0)
                              .build()
                              .unwrap()
...
pub fn julian_day_zero(year: i32) -> AstroResult<AstroTime> {
    ...
    Builder::from_julian_date(f64::floor(365.25 * y) - a + f64::floor(a / 4.0) + 1_721_424.5)
        .build()
}
...
pub fn day_of_year_gregorian(year: i32, month: i32, day: i32) -> AstroResult<i32> {
    ...
    if is_valid_gregorian(year, month, day) {
        #[allow(non_snake_case)]
        let K: f64 = if is_gregorian_leap_year(year) {
            1.0
        } else {
            2.0
        };
...
pub fn month_and_day_gregorian(year: i32, day_of_year: i32) -> AstroResult<(i32, i32)> {
    ...
    #[allow(non_snake_case)]
    let mut M: i32 = f64::floor((9.0 * (K + day_of_year as f64) / 275.0) + 0.98) as i32;
    if day_of_year < 32 {
        M = 1;
    }
...
pub fn is_valid_gregorian(year: i32, month: i32, day: i32) -> bool {
    if month < 1 || month > 12 || day < 1 || day > days_per_month_gregorian(month, year) {
        false
    } else {
        true
    }
...
pub fn is_valid_julian(year: i32, month: i32, day: i32) -> bool {
    if month < 1 || month > 12 || day < 1 || day > days_per_month_julian(month, year) {
        false
    } else {
        true
    }
...
fn days_per_month_julian(month: i32, year: i32) -> i32 {
    ...
    match month {
        1 | 3 | 5 | 7 | 8 | 10 | 12 => 31,
        4 | 6 | 9 | 11 => 30,
        2 => if is_julian_leap_year(year) { 29 } else { 28 },
        // Should not be able to panic if dates were validated before using this function.
        _ => panic!("Invalid month."),
    }
}
